...
<ul class="list--image">
  ...
  <li><img width="32" height="32" src="https://cdn.breadboards.app/assets/documentation/03_Style editor_3_2.png"><p><b>Relative</b>: The element stays in the normal flow, but you can use <b>X (Left)</b> and <b>Y (Top)</b> to shift its appearance without affecting the space it originally occupied.</p></li>
...
<ul class="list--image">
  <li><img width="32" height="32" src="https://cdn.breadboards.app/assets/documentation/03_Style editor_3_4.png"><p><b>Absolute</b>: The element is placed at a specific <b>X(Left)</b> and <b>Y(Top)</b> position relative to its parent container.</p></li>
